import svgPaths from "./svg-emek1rwhce";
import imgImageWithFallback from "figma:asset/4743b509a869bce4ea465b117a4b89392851d1eb.png";

function Heading() {
  return (
    <div className="h-[23.991px] relative shrink-0 w-[126.009px]" data-name="Heading 2">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Pretendard:SemiBold',sans-serif] leading-[24px] left-0 not-italic text-[#f5f5f5] text-[16px] text-nowrap top-[-0.68px]">product-hero.jpg</p>
      </div>
    </div>
  );
}
...
function FileDetailDialog() {
  return (
    <div className="absolute content-stretch flex h-[60.565px] items-center justify-between left-0 pb-[0.579px] pl-[24px] pr-[39.996px] pt-0 top-0 w-[1150.839px]" data-name="FileDetailDialog">
...
function ImageWithFallback() {
  return (
    <div className="absolute h-[279.983px] left-[247.43px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_-1px_rgba(0,0,0,0.1)] top-[153.49px] w-[399.981px]" data-name="ImageWithFallback">
...
function Paragraph1() {
  return (
    <div className="h-[19.989px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Pretendard:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#f5f5f5] text-[14px] text-nowrap top-[-0.84px]">2025-10-16 14:30</p>
    </div>
  );
}
...
function Paragraph2() {
  return (
    <div className="h-[16.006px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Pretendard:Medium',sans-serif] leading-[16px] left-0 not-italic text-[#a1a1aa] text-[12px] text-nowrap top-[-0.42px]">크기</p>
    </div>
  );
}
...
function Paragraph3() {
  return (
    <div className="h-[19.989px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Pretendard:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#f5f5f5] text-[14px] text-nowrap top-[-0.84px]">2.4MB</p>
    </div>
  );
}
...
function Paragraph5() {
  return (
    <div className="h-[19.989px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Pretendard:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#f5f5f5] text-[14px] text-nowrap top-[-0.84px]">1920x1080</p>
    </div>
  );
}
...
function Paragraph6() {
  return (
    <div className="h-[16.006px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Pretendard:Medium',sans-serif] leading-[16px] left-0 not-italic text-[#a1a1aa] text-[12px] text-nowrap top-[-0.42px]">사용자</p>
    </div>
  );
}
...
function Paragraph7() {
  return (
    <div className="h-[19.989px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Pretendard:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#f5f5f5] text-[14px] text-nowrap top-[-0.84px]">jin@reconlabs.ai</p>
    </div>
  );
}
...
function Container5() {
  return (
    <div className="content-stretch flex flex-col gap-[15.997px] h-[207.939px] items-start relative shrink-0 w-full" data-name="Container">
      <Container1 />
      <Container2 />
      <Container3 />
      <Container4 />
...
function Container6() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[15.997px] h-[292.503px] items-start left-0 pb-[0.579px] pt-[24px] px-[24px] top-0 w-[255.993px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[0px_0px_0.579px] border-[rgba(163,163,163,0.2)] border-solid inset-0 pointer-events-none" />
      <Heading1 />
      <Container5 />
    </div>
...
function Heading2() {
  return (
    <div className="h-[19.989px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute font-['Pretendard:SemiBold',sans-serif] leading-[20px] left-0 not-italic text-[#f5f5f5] text-[14px] text-nowrap top-[-0.84px]">배율 옵션</p>
    </div>
  );
}
...
function Button2() {
  return (
    <div className="basis-0 bg-[rgba(245,245,245,0.05)] grow h-[35.47px] min-h-px min-w-px relative rounded-[10px] shrink-0" data-name="Button">
      <div aria-hidden="true" className="absolute border-[0.579px] border-[rgba(163,163,163,0.2)] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Pretendard:Medium',sans-serif] leading-[16px] left-[22.82px] not-italic text-[#f5f5f5] text-[12px] text-center text-nowrap top-[9.31px] translate-x-[-50%]">x3</p>
      </div>
    </div>
  );
}
...
function Button3() {
  return (
    <div className="basis-0 bg-[rgba(245,245,245,0.05)] grow h-[35.47px] min-h-px min-w-px relative rounded-[10px] shrink-0" data-name="Button">
      <div aria-hidden="true" className="absolute border-[0.579px] border-[rgba(163,163,163,0.2)] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Pretendard:Medium',sans-serif] leading-[16px] left-[22.99px] not-italic text-[#f5f5f5] text-[12px] text-center text-nowrap top-[9.31px] translate-x-[-50%]">x2</p>
      </div>
    </div>
  );
}
...
function Button4() {
  return (
    <div className="basis-0 bg-[rgba(79,168,216,0.2)] grow h-[35.47px] min-h-px min-w-px relative rounded-[10px] shrink-0" data-name="Button">
      <div aria-hidden="true" className="absolute border-[#4fa8d8] border-[1.738px] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Pretendard:Medium',sans-serif] leading-[16px] left-[24.02px] not-italic text-[#4fa8d8] text-[12px] text-center text-nowrap top-[9.31px] translate-x-[-50%]">x1</p>
      </div>
    </div>
  );
}
...
function Button5() {
  return (
    <div className="basis-0 bg-[rgba(245,245,245,0.05)] grow h-[35.47px] min-h-px min-w-px relative rounded-[10px] shrink-0" data-name="Button">
      <div aria-hidden="true" className="absolute border-[0.579px] border-[rgba(163,163,163,0.2)] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Pretendard:Medium',sans-serif] leading-[16px] left-[22.86px] not-italic text-[#f5f5f5] text-[12px] text-center text-nowrap top-[9.31px] translate-x-[-50%]">x0.5</p>
      </div>
    </div>
  );
}
...
function Container7() {
  return (
    <div className="content-stretch flex gap-[7.994px] h-[35.47px] items-start pl-0 pr-[-0.018px] py-0 relative shrink-0 w-full" data-name="Container">
      <Button2 />
      <Button3 />
      <Button4 />
      <Button5 />
...
function Container8() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[15.997px] h-[120.034px] items-start left-0 pb-[0.579px] pt-[24px] px-[24px] top-[292.5px] w-[255.993px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[0px_0px_0.579px] border-[rgba(163,163,163,0.2)] border-solid inset-0 pointer-events-none" />
      <Heading2 />
      <Container7 />
    </div>
...
function Container9() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[11.995px] h-[107.994px] items-start left-[24px] top-[436.54px] w-[207.993px]" data-name="Container">
      <Button6 />
      <Button7 />
    </div>
  );
...
function FileDetailDialog1() {
  return (
    <div className="absolute bg-[rgba(82,82,91,0.3)] h-[586.962px] left-0 overflow-clip top-[60.57px] w-[1150.839px]" data-name="FileDetailDialog">
      <ImageWithFallback />
      <Container11 />
    </div>
  );
