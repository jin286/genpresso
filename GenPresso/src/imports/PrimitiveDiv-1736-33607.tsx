import svgPaths from "./svg-8o514el2i6";
...
function Container6() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[11.995px] h-[167.988px] items-start left-[24px] top-[260.52px] w-[207.993px]" data-name="Container">
      <Button2 />
      <Button3 />
      <Button4 />
    </div>
